...
- إضافة مشغّل Startup غير مرتفع يظهر Switch في قائمة Startup Apps.
- تشغيل التطبيق المرتفع عبر Scheduled Task مع مسار احتياطي عند تسجيل الدخول.
- تنظيف تسجيلات startup القديمة أثناء التثبيت والترقية.
